...
1. Mars Rover Resources (NASA)
    ...
    1. Perseverance rover (Mars 2020)
2. Mars Rover Game(s)
    1. NASA games
    1. Make your own rover game
3. Python Programming (online)
    1. Python interpreters online
    1. General (free) Python programming stuff for kids
    1. General (free) Python programming stuff for beginners (not necessarily for kids)
...
* Interactive (waypoint) rover driving
